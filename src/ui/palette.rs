...
pub(crate) use crate::theme::{
    ACCENT, BACKGROUND, BORDER, COPY_MODE_INDICATOR_BG, COPY_MODE_INDICATOR_FG, FLAG_WARN,
    FOREGROUND, MUTED, PANEL, SESSION_BG, SURFACE_TERMINAL, TAB_ACTIVE_BG, TAB_BAR_BG,
};
