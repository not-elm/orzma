...
//! back-channel bridge (`ozma_bridge.js`), injected ahead of any
...
/// Builds the preload for a bridged Tier 1 webview: the `window.ozma`
...
mod tests {
    ...
    #[test]
    fn build_preload_injects_the_ozma_bridge_first() {
    ...
    fn user_scripts_are_appended_after_the_bridge() {
        ...
        assert_eq!(preload.0[0], OZMA_BRIDGE_JS, "bridge first");
